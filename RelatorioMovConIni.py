...
class RelatorioMovConIni(Report):


    title = u'Relatório de Movimento Contábil Inicial - Competência: '
    print_if_empty = True        
    ...
    class band_page_header(ReportBand):
        ...
        height = 1.3*cm
        elements = [
            SystemField(expression=u'Relatório de Movimento Contábil Inicial - Competência: %(var:competencia)s', top=0.1*cm, left=0, width=BAND_WIDTH, 
