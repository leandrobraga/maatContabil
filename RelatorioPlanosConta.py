...
class RelatorioPlanosConta(Report):


    title = u'Relatório de Plano de Contas - Competência: '
    print_if_empty = True        
    ...
    class band_page_header(ReportBand):
        ...
        height = 1.3*cm
        elements = [
            SystemField(expression=u'Relatório de Plano de Contas - Competência: %(var:competencia)s', top=0.1*cm, left=0, width=BAND_WIDTH, 
    ...
    class band_detail(ReportBand):
        ...
        elements = [
            ...
            Label(text=u"Conta:", top=0.5*cm, left=0, style={'fontName':'Helvetica-Bold'}),
            Label(text=u"Descrição:", top=0.5*cm, left=7*cm, style={'fontName':'Helvetica-Bold'}),
            

            ObjectValue(attribute_name='conta', top=0.5*cm, left=1.5*cm),
            ObjectValue(attribute_name='descricao', width=10*cm , top=0.5*cm, left=9.5*cm),
