...
class RelatorioMovConFinal(Report):


    title = u'Relatório de Movimento Contábil Final - Competência: '
    print_if_empty = True        
    ...
    class band_page_header(ReportBand):
        ...
        height = 1.3*cm
        elements = [
            SystemField(expression=u'Relatório de Movimento Contábil Final - Competência: %(var:competencia)s', top=0.1*cm, left=0, width=BAND_WIDTH, 
