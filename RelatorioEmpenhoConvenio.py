...
class RelatorioEmpenhoConvenio(Report):
    ...
    class band_page_header(ReportBand):
        height = 1.3*cm
        elements = [
            SystemField(expression=u'Relatório de Empenhos de Convênios - Competência: %(var:competencia)s', top=0.1*cm, left=0, width=BAND_WIDTH, 
